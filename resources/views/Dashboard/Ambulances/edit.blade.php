...
@endsection
@section('title')
{{trans('Dashboard/Ambulance.new_ambulance')}}
@endsection
@section('page-header')
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Ambulance.update','test')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Dashboard/Ambulance.number_voiture')}}</label>
                        ...
                        <div class="col">
                            <label>{{trans('Dashboard/Ambulance.Type')}}</label>
                            <select class="form-control" name="car_type">
                                <option value="1" {{$ambulance->car_type == 1 ? 'selected':''}}>{{trans('Dashboard/Ambulance.Owner')}}</option>
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{trans('Dashboard/Ambulance.reserver')}}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label>{{trans('Dashboard/Ambulance.tele')}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Dashboard/Ambulance.Remarques')}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Dashboard/Ambulance.status')}}</label>
                            &nbsp;
