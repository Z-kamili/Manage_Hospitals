...
@endsection
@section('title')
{{trans('Dashboard/main-sidebar_trans.Add_patient')}}
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar_trans.Patients')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{trans('Dashboard/main-sidebar_trans.Add_patient')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Patients.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label>{{trans('Dashboard\Patient.name')}}</label>
                        ...
                        <div class="col">
                            <label>{{trans('Dashboard\Patient.date_of_birth')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label>{{trans('Dashboard\Patient.sex')}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Dashboard\Patient.Adress')}}</label>
